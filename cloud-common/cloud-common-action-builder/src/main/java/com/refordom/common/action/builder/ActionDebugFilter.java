 ...
 */
public class ActionDebugFilter implements Filter {
    static final String ALREADY_FILTERED_ATTR_NAME = ActionDebugFilter.class.getName()
            .concat(".FILTERED");

    private final ActionFilterChainProxy fcp;

    private final Log logger = LogFactory.getLog(getClass());

    public ActionDebugFilter(ActionFilterChainProxy fcp) {
        this.fcp = fcp;
    }
    ...
    private String formatChains(ActionFilterChain appFilterChain) {
        StringBuilder sb = new StringBuilder();
    ...
    private ActionFilterChain getFilters(HttpServletRequest request) {
        for (ActionFilterChain chain : fcp.getFilterChains()) {
